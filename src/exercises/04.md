...
-   [react-window](https://github.com/bvaughn/react-window), concept called _windowing_, nothing really new in terms of performance optimizations in React, but this library makes them easy to use
-   Remember that windowing will affect accessibility (a11y); [downshift](https://github.com/downshift-js/downshift) can help with this
